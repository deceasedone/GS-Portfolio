    ...
    content: (
      <div className="grid grid-cols-2 gap-4 w-full h-full">
        <img
          ...
          alt="Tab 1"
          className="rounded-lg w-full h-60 object-cover shadow-[0_0_20px_rgba(0,0,0,0.2)] border-none"
        />
        <div className="flex flex-col gap-y-2">
          <h2 className="text-2xl font-bold text-white">Tab 1</h2>
  ...
  },
  {
    ...
    content: (
      <div className="grid grid-cols-2 gap-4 w-full h-full">
        ...
        />
        <div className="flex flex-col gap-y-2">
          <h2 className="text-2xl font-bold text-white">Tab 2</h2>
          <p className="text-sm text-gray-200">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam,
            quos.
          </p>
  ...
  },
  {
    ...
    content: (
      <div className="grid grid-cols-2 gap-4 w-full h-full">
        ...
        />
        <div className="flex flex-col gap-y-2">
          <h2 className="text-2xl font-bold text-white">Tab 3</h2>
          <p className="text-sm text-gray-200">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam,
            quos.
          </p>
...
const AnimatedTabs = ({
  ...
  const handleChange = (nextId) => {
    if (isControlled) {
      onTabChange && onTabChange(nextId);
    } else {
      setUncontrolledActiveTab(nextId);
    }
  };
  ...
  return (
    <div
      className={cn(
        "w-full max-w-lg mx-auto flex flex-col gap-y-1",
        className
      )}
    >
      {/* Tabs Header */}
